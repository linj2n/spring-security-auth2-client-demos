...
public class CustomUserInfoTokenService implements ResourceServerTokenServices {
    protected final Log logger = LogFactory.getLog(CustomUserInfoTokenService.class);

    protected final String userInfoEndpointUrl;
    ...
    protected AuthoritiesExtractor authoritiesExtractor = new FixedAuthoritiesExtractor();

    protected PrincipalExtractor principalExtractor = new FixedPrincipalExtractor();
